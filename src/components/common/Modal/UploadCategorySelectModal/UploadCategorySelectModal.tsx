import styles from '../CategorySelectModal/CategorySelectModal.module.css';
import { useAtomValue } from 'jotai';
import {
    useCategoriesQuery,
    uploadCurrentCategoriesAtom,
    useUploadCategoryNavigation,
    uploadCategoryPathAtom,
} from '@/store/category';
...
function CategoryList({ close }: { close: () => void }) {
    const currentCategories = useAtomValue(uploadCurrentCategoriesAtom);
...
function CategoryHeader() {
    const { goToParent } = useUploadCategoryNavigation();
    const selectedPath = useAtomValue(uploadCategoryPathAtom);
...
export function UploadCategorySelectModal({ isOpen, close, unmount }: UploadCategorySelectModalProps) {
